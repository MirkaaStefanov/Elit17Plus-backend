package com.example.Elit17Plus_backend.config;


import com.example.Elit17Plus_backend.exceptions.user.UserNotFoundException;
import com.example.Elit17Plus_backend.models.baseEntity.BaseEntity;
import com.example.Elit17Plus_backend.models.dto.PatientDTO;
import com.example.Elit17Plus_backend.models.dto.common.BaseDTO;
    ...
    private void configurePatientMappings(ModelMapper modelMapper) {
        ...
        modelMapper.createTypeMap(Patient.class, PatientDTO.class)
                .addMappings(mapper -> mapper.using(toBase64)
                        .map(Patient::getImageData, PatientDTO::setImage));
    }
